      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <div class="card-group d-block d-md-flex row">                                          
            <div class="d-none d-sm-none d-md-block card col-md-5 py-5" style="background-image: url('{{ asset('app/img/pexels-alesia-kozik-6771178.jpg') }}'); background-size: cover;">
            ...
            <div class="card col-md-7 p-4 mb-0">
              <div class="card-body">
                  ...
                  <form class="form-sample form-submit" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="mb-3">
                      <!-- Agregar el hiperv�nculo para registrarse -->
                      <p class="mt-3">&iquest;No est&aacute;s registrado? <a href="{{ route('add') }}">Reg&iacute;strate aqu&iacute;</a></p>
                    </div>
                  </form>
              </div>
            </div>
